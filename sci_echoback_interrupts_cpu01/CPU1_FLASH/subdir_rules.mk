...
Example_2837xSSci_FFDLB_int.obj: D:/ti/controlSUITE/device_support/F2837xS/v180/F2837xS_examples_Cpu1/sci_loopback_interrupts/cpu01/Example_2837xSSci_FFDLB_int.c $(GEN_OPTS) | $(GEN_HDRS)
	@echo 'Building file: $<'
	@echo 'Invoking: C2000 Compiler'
	"D:/ti/ccs700/ccsv7/tools/compiler/ti-cgt-c2000_16.9.1.LTS/bin/cl2000" -v28 -ml -mt --cla_support=cla1 --float_support=fpu32 --tmu_support=tmu0 --vcu_support=vcu2 --include_path="D:/ti/ccs700/ccsv7/tools/compiler/ti-cgt-c2000_16.9.1.LTS/include" --include_path="D:/ti/controlSUITE/device_support/F2837xS/v180/F2837xS_headers/include" --include_path="D:/ti/controlSUITE/device_support/F2837xS/v180/F2837xS_common/include" -g --define=CPU1 --define=_LAUNCHXL_F28377S --define=_FLASH --diag_warning=225 --display_error_number --diag_suppress=10063 --preproc_with_compile --preproc_dependency="Example_2837xSSci_FFDLB_int.d" $(GEN_OPTS__FLAG) "$<"
